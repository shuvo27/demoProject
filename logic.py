...
wait = WebDriverWait(driver, 10).until(
    expected_conditions.presence_of_element_located((By.XPATH, '//input[@class="promoCode"]')))
...
totals = driver.find_elements(By.XPATH, '//tr/td[5]/p')
...
totalSum = int(driver.find_element(By.XPATH, '//span[@class="totAmt"]').text)
